...
class ErpShadows {
  ...
  static List<BoxShadow> lightMd = [
    BoxShadow(color: Color(0x12000000), blurRadius: 6, spreadRadius: -1, offset: Offset(0, 4)),
    BoxShadow(color: Color(0x0A000000), blurRadius: 4, spreadRadius: -1, offset: Offset(0, 2)),
  ];

  static List<BoxShadow> lightLg = [
    BoxShadow(color: Color(0x14000000), blurRadius: 15, spreadRadius: -3, offset: Offset(0, 10)),
    BoxShadow(color: Color(0x08000000), blurRadius: 6, spreadRadius: -2, offset: Offset(0, 4)),
  ];
  ...
  static List<BoxShadow> darkMd = [
    BoxShadow(color: Color(0x66000000), blurRadius: 6, spreadRadius: -1, offset: Offset(0, 4)),
  ];
}
...
ThemeData erpLightTheme = ThemeData(
  ...
  colorScheme: ColorScheme.light(
    ...
    background: ErpColors.bgLightMain,
    onBackground: ErpColors.textLightMain,
  ...
  fontFamily: 'Inter',
  textTheme: TextTheme(
    displayLarge: TextStyle(color: ErpColors.textLightMain, fontWeight: FontWeight.w800),
    displayMedium: TextStyle(color: ErpColors.textLightMain, fontWeight: FontWeight.w700),
    headlineLarge: TextStyle(color: ErpColors.textLightMain, fontWeight: FontWeight.w700),
    headlineMedium: TextStyle(color: ErpColors.textLightMain, fontWeight: FontWeight.w600),
    titleLarge: TextStyle(color: ErpColors.textLightMain, fontWeight: FontWeight.w600),
    titleMedium: TextStyle(color: ErpColors.textLightMain, fontWeight: FontWeight.w500),
    bodyLarge: TextStyle(color: ErpColors.textLightMain, fontWeight: FontWeight.w400),
    bodyMedium: TextStyle(color: ErpColors.textLightMain, fontWeight: FontWeight.w400),
    bodySmall: TextStyle(color: ErpColors.textLightMuted, fontWeight: FontWeight.w400),
    labelLarge: TextStyle(color: ErpColors.textLightMain, fontWeight: FontWeight.w500),
    labelSmall: TextStyle(color: ErpColors.textLightMuted, fontWeight: FontWeight.w500),
  ),
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
      ...
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(ErpRadius.sm)),
...
ThemeData erpDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme.dark(
    ...
    background: ErpColors.bgDarkMain,
    onBackground: ErpColors.textDarkMain,
    error: ErpColors.red500,
    onError: Colors.white,
  ...
  fontFamily: 'Inter',
  textTheme: TextTheme(
    displayLarge: TextStyle(color: ErpColors.textDarkMain, fontWeight: FontWeight.w800),
    displayMedium: TextStyle(color: ErpColors.textDarkMain, fontWeight: FontWeight.w700),
    headlineLarge: TextStyle(color: ErpColors.textDarkMain, fontWeight: FontWeight.w700),
    headlineMedium: TextStyle(color: ErpColors.textDarkMain, fontWeight: FontWeight.w600),
    titleLarge: TextStyle(color: ErpColors.textDarkMain, fontWeight: FontWeight.w600),
    titleMedium: TextStyle(color: ErpColors.textDarkMain, fontWeight: FontWeight.w500),
    bodyLarge: TextStyle(color: ErpColors.textDarkMain, fontWeight: FontWeight.w400),
    bodyMedium: TextStyle(color: ErpColors.textDarkMain, fontWeight: FontWeight.w400),
    bodySmall: TextStyle(color: ErpColors.textDarkMuted, fontWeight: FontWeight.w400),
    labelLarge: TextStyle(color: ErpColors.textDarkMain, fontWeight: FontWeight.w500),
    labelSmall: TextStyle(color: ErpColors.textDarkMuted, fontWeight: FontWeight.w500),
  ),
  appBarTheme: AppBarTheme(
