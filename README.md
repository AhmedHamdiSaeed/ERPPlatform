...
* Check the `ConnectionStrings` in `appsettings.json` files under the `ERPPlatform.HttpApi.Host` and `ERPPlatform.DbMigrator` projects and change it if you need.
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 5f5a3fe0-b020-4bc4-8b40-924b9284753b
```

> `5f5a3fe0-b020-4bc4-8b40-924b9284753b` is the password of the certificate, you can change it to any password you want.
